...
--   Hạn = NGÀY BBCB QĐKT + 5 ngày làm việc. Nếu NGÀY BBKT trễ hơn hạn thì
--   số ngày quá hạn = số ngày làm việc vượt quá hạn.
...
begin
  ...
  -- Số ngày quá hạn (hạn = NGÀY BBCB QĐKT + 5 ngày làm việc, so với NGÀY BBKT)
